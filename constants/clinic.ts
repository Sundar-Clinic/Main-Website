		...
		descriptions: [
			{
				...
				ta: 'இந்த வலைத்தளத்தில் உள்ள அனைத்து உள்ளடக்கங்களும், உரை, கிராபிக்ஸ், லோகோக்கள், படங்கள் மற்றும் மென்பொருள் ஆகியவை அறிவுசார் உரிமையினால் பாதுகாக்கப்பட்டுள்ளன. எங்கள் முன் எழுதப்பட்ட அனுமதி இன்றி நீங்கள் எந்த உள்ளடக்கத்தையும் உருவாக்கவோ, பகிரவோ அல்லது பயன்படுத்தவோ முடியாது.',
